...
abstract contract OptimizedOApp is Ownable {
    ...
    function setPeers(uint32[] calldata _remoteEids, bytes32[] calldata _remoteAddresses) external onlyOwner {
    ...
    function setGasLimit(uint32[] calldata _remoteEids, uint128[] calldata _gasLimits) external onlyOwner {
